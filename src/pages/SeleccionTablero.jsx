...
export default function SeleccionTablero() {
  ...
  const tablerosDisponibles = [
    ...
    },
    {
      ...
      color: 'from-red-900/70 to-red-600/50'
    },
    {
      id: 'VerdeEsmeralda',
    ...
    },
    {
      id: 'GemaMorada',
      nombre: 'Gema Morada',
      imagen: '/assets/tablero/GemaMorada.png',
      color: 'from-amber-900/70 to-amber-600/50'
    },
    {
      id: 'Cristal',
      nombre: 'Cristal',
      imagen: '/assets/tablero/Cristal.png',
      color: 'from-amber-900/70 to-amber-600/50'
    },
  ];
  ...
  const tableroDefault = {
    ...
    nombre: 'Clásico',
    imagen: '/assets/tablero/AzulCristal.png',
    color: 'from-gray-900/70 to-gray-600/50'
  };
  ...
  const seleccionarTablero = (tableroId) => {
    ...
    if (tableroElement) {
      tableroElement.classList.add('ring-purple-400', 'shadow-purple-glow');
      setTimeout(() => {
        tableroElement.classList.remove('ring-purple-400', 'shadow-purple-glow');
      }, 1000);
    }
  };
  ...
  if (loading) return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="flex flex-col items-center">
        ...
        <p className="text-purple-300 font-mono tracking-widest">CARGANDO TABLEROS...</p>
      </div>
    </div>
  );
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-400">
            {selectedTablero ? (
              <span>
                Diseño actual: <span className="text-purple-300 font-bold">{
        ...
        {/* Grid de tableros estilo futurista */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tablerosDisponibles.map((tablero) => (
            ...
            >
              ...
              {/* Imagen del tablero con efecto */}
              <div className="relative h-48 mb-6 flex justify-center">
                <div className={`absolute inset-0 bg-gradient-to-br ${tablero.color} rounded-lg z-10 opacity-70`} />
                <img 
                  src={tablero.imagen} 
                  alt={tablero.nombre}
                  className="w-full h-full object-cover rounded-lg z-20 transition-transform group-hover:scale-105"
                  onError={(e) => {
                    e.target.src = tableroDefault.imagen;
                  }}
                />
              </div>
